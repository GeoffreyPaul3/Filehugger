export default function PrivacyPolicy() {
    return (
      <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
        <p>Effective Date: Wed 7 Dec 2023</p>
        <p>
          At Filehugger, we are committed to safeguarding your privacy. This Privacy
        ...
        <p>
          By using Filehugger, you agree to the practices outlined in this Privacy
